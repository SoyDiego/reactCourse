...
describe("Pruebas en las acciones Auth", () => {
	...
	test("startLogin correcto", async () => {
		await store.dispatch(startLogin("diegofranchina@gmail.com", "123456"));
	...
	test("startLogin incorrecto", async () => {
		await store.dispatch(
			startLogin("diegofranchina@gmail.com", "123456789")
		);
		...
		await store.dispatch(startLogin("diegofranchina@gmail2.com", "123456"));

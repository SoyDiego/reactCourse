...
describe("Pruebas en LoginScreen", () => {
	...
	test("Debe de llamar el dispatch del login ", () => {
		//Esto iria normalmente (en nuestro caso no porque he dejado el login completado en el front para que puedan utilizarlo)
		...
		expect(startLogin).toHaveBeenCalledWith("testing@gmail.com", "123456");
	});
